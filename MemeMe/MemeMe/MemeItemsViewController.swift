...
class MemeItemsViewController: UIViewController {
    ...
    private func produceAddMemeButton() -> UIBarButtonItem {
        return UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.Add, target: self, action: #selector(MemeItemsViewController.addMemeAction(_:)))
    }
    

    private func produceEditButton() -> UIBarButtonItem {
        return UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.Edit, target: self, action: #selector(MemeItemsViewController.enableEditModeAction(_:)))
    }
    

    private func produceCancelButton() -> UIBarButtonItem {
        return UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.Cancel, target: self, action: #selector(MemeItemsViewController.disableEditModeAction(_:)))
    }
    

    private func produceDeleteButton() -> UIBarButtonItem {
        return UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.Trash, target: self, action: #selector(MemeItemsViewController.deleteSelectedMemesAction(_:)))
    }
